...
public final class WirelessConnectorClientEvents {
    ...
    public static void onMouseScroll(InputEvent.MouseScrollingEvent event) {
        ...
        if (WirelessConnectorChannelState.cycleSelectedChannel(minecraft, event.getScrollDelta())) {
    ...
    public static void onRenderGui(RenderGuiOverlayEvent.Post event) {
        ResourceLocation hotbarId = VanillaGuiOverlay.HOTBAR.id();
        if (!event.getOverlay().id().equals(hotbarId)) return;
